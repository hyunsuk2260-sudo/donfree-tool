...
/* 안정성이 검증된 폰트 전용 웹폰트 및 대체 스타일 적용 */
...
@font-face { font-family: 'KOTRA_BOLD'; src: url('https://cdn.jsdelivr.net/gh/projectnoonnu/noonfonts_20-10@1.0/KOTRA_BOLD.woff2') format('woff2'); font-weight: normal; font-style: normal; }
...
.font-wagak { font-family: 'WAGAK', 'Black Han Sans', sans-serif; }
.font-kotra { font-family: 'KOTRA_BOLD', 'Jua', sans-serif; }
